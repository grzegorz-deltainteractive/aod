            ...
            @section('breadcrumbs')
                <ol class="breadcrumb hidden-xs">
                    @php
                        ...
                        $segments = getBreadcrumbs($segments);
                    ...
                    @else
                        ...
                        @foreach ($segments as $segment)
                            ...
                            @endphp
                            @if ($loop->last)
                                <li>{{ ucfirst(urldecode($segmentTitle)) }}</li>
                            @else
                                <li>
                                    <a href="{{ $url }}">{{ ucfirst(urldecode($segmentTitle)) }}</a>
                                </li>
                            @endif
                        @endforeach
                    @endif
        ...
        <ul class="nav navbar-nav @if (__('voyager::generic.is_rtl') == 'true') navbar-left @else navbar-right @endif">
            <li class="dropdown profile">
                <a href="#" class="dropdown-toggle text-right" data-toggle="dropdown" role="button"
                   aria-expanded="false"><img src="/images/gray_moj-panel.png" class="profile-img"> <span
                        class="caret"></span></a>
                <ul class="dropdown-menu dropdown-menu-animated">
                    <li class="profile-img">
                        <img src="/images/gray_moj-panel.png" class="profile-img">
