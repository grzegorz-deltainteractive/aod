...
@section('content')
    <div class="page-content read container-fluid">
        ...
        $laboratorium = \App\Models\Laboratory::where('id', $laboratoriumId)->first();
        ?>
                ...
                <div class="panel panel-bordered" style="padding:15px;">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item active">
                            <a class="nav-link" id="ankiety-tab" data-toggle="tab" href="#ankiety" role="tab" aria-controls="ankiety" aria-selected="true" aria-expanded="true">Ankiety dla laboratorium</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane active in" id="ankiety" role="tabpanel" aria-labelledby="ankiety-tab">
                            <h4>Ankiety dla laboratorium</h4>
                            <?php $pools = \App\Models\Pool::getPoolsByLaboratory($dataTypeContent->id);?>
                            @if (empty($pools))
                                <h5>Brak ankiet</h5>
                            @else
                                <div class="row">
