...
@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            <img src="/images/gray_ankiety.png" alt="" class="header-icon-img" /> {{ $dataType->getTranslatedAttribute('display_name_plural') }}
        </h1>
...
//        dd($dataTypeContent);
        foreach ($dataTypeContent as $data) {
            ...
            if (isset($data->data_wydania_ankiety) && !empty($data->data_wydania_ankiety)) {
                $year = date('Y', strtotime($data->data_wydania_ankiety));
