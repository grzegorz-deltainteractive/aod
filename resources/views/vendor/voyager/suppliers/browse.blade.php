...
@section('page_header')
    ...
    <div class="container-fluid">
		...
		<div style="display:none; margin-top:-102px; background:#fff; right:420px; position:fixed; border:1px solid green;  index-z:9999; width:400px; padding:15px;  -webkit-border-radius: 3px;
